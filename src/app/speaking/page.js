...
export default function SpeakingPage() {
  return (
    <div className="bg-white dark:bg-[#0b1727] text-gray-800 dark:text-white">
      ...
      {/* Hero Section */}
      <Hero
        sectionClass="speaking-hero"
        bgImage="/PublicSPeakking.png"
        header="Speaking"
      />
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold leading-snug">
              Just a few of the 500 brands who've entrusted their audiences to
              Mark Phelan
            </h2>
          </div>
      ...
      <section className="z-10 relative py-20 px-6 text-center bg-white dark:bg-[#0b1727]">
        ...
        <p className="text-md text-gray-600 dark:text-gray-300 mb-8">
          Dive into Mark's approach to storytelling and learn how he captivates
          audiences in under 4 minutes.
        </p>
        ...
        <div className="space-y-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-white dark:bg-[#2a2a2a] p-6 rounded-lg shadow-lg">
              <p className="text-sm font-bold text-cyan-600 uppercase mb-2">
                Fan Favorite of 2023
              </p>
              <h3 className="text-2xl font-semibold mb-2">
                The Cube of Creativity
              </h3>
              <p className="mb-4">
                Why adding constraints sparks innovation, action, & builds
                business. Discover how Mark turns limitations into launchpads
                for success using stories of grit and invention.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="order-2 md:order-1 bg-white dark:bg-[#2a2a2a] p-6 rounded-lg shadow-lg">
              <p className="text-sm font-bold text-pink-600 uppercase mb-2">
                Expanded for 2025
              </p>
              <h3 className="text-2xl font-semibold mb-2">
              ...
              <p className="mb-4">
                How savvy brands are safely using the magic of AI. Learn how to
                navigate AI’s potential without sacrificing authenticity or
                trust in your brand journey.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-white dark:bg-[#2a2a2a] p-6 rounded-lg shadow-lg">
              ...
              <p className="mb-4">
                How small things add up to big business. Learn how small moments
                can build trust, anticipation, and transformation in your
      ...
      <section className="z-10 relative py-16 text-center bg-[#ffe6cc] dark:bg-[#2a1e13]">
        ...
        <p className="italic max-w-xl mx-auto">
          "Mark’s coaching sessions are the most impactful of any program I’ve
          participated in — insightful, energizing, and life-changing."
        </p>
