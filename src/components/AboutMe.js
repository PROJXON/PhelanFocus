...
const AboutMe = () => {
	return (
		<section id="about" className="ezy__about17 light pt-14 md:pt-24 pb-14 lg:pb-0 bg-white dark:bg-[#0b1727] text-zinc-900 dark:text-white relative overflow-hidden z-[1]">
			<ShapeThree />
			<ShapeFour />
